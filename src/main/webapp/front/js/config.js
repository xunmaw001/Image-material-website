...
var centerMenu = [
    ...
    ,{
        name: '高清背景收藏',
        url: '../beijingCollection/list.html'
    }
    ,{
        name: '免扣元素收藏',
        url: '../yuansuCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '高清背景',
        url: './pages/beijing/list.html'
    },


    {
        name: '免扣元素',
        url: './pages/yuansu/list.html'
    },
...
var adminurl =  "http://localhost:8080/tupiansucai/admin/dist/index.html#/login";

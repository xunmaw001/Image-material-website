...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='beijing'">
                    <el-form-item class="select" v-if="type!='info'"  label="高清背景" prop="beijingId">
                        <el-select v-model="ruleForm.beijingId" filterable placeholder="请选择高清背景" @change="beijingChange">
                            <el-option
                                    v-for="(item,index) in beijingOptions"
                                    v-bind:key="item.id"
                                    :label="item.beijingName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='beijing' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="高清背景名称" prop="beijingName">
                        <el-input v-model="beijingForm.beijingName"
                                  placeholder="高清背景名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='beijing' && type!='info'">
                    <el-form-item class="upload" v-if="type!='info' && !ro.beijingPhoto" label="高清背景照片" prop="beijingPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (beijingForm.beijingPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='beijing' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="高清背景分类" prop="beijingValue">
                        <el-input v-model="beijingForm.beijingValue"
                                  placeholder="高清背景分类" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='beijing' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="高清背景格式" prop="beijingGeshiValue">
                        <el-input v-model="beijingForm.beijingGeshiValue"
                                  placeholder="高清背景格式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='beijing' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="板式" prop="beijingBanshiValue">
                        <el-input v-model="beijingForm.beijingBanshiValue"
                                  placeholder="板式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="beijingId" name="beijingId" type="hidden">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   beijingId: [
                              { required: true, message: '高清背景不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
        ...
        created() {
         ...
         this.$http({
             url: `beijing/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.beijingOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='beijingId'){
                          this.ruleForm.beijingId = obj[o];
                          this.ro.beijingId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
            ...
            info(id) {
                this.$http({
                    url: `beijingCollection/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm = data.data;
                        this.beijingChange(data.data.beijingId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`beijingCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.beijingCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();

 ...
 */
@TableName("beijing_xiazaijilu")
public class BeijingXiazaijiluView extends BeijingXiazaijiluEntity implements Serializable {
	...
	public BeijingXiazaijiluView() {

	}

	public BeijingXiazaijiluView(BeijingXiazaijiluEntity beijingXiazaijiluEntity) {
		try {
			BeanUtils.copyProperties(this, beijingXiazaijiluEntity);

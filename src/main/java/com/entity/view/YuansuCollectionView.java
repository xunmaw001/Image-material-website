 ...
 */
@TableName("yuansu_collection")
public class YuansuCollectionView extends YuansuCollectionEntity implements Serializable {
	...
	public YuansuCollectionView() {

	}

	public YuansuCollectionView(YuansuCollectionEntity yuansuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yuansuCollectionEntity);
